  ...
  return(
      <footer className='min-h-screen bg-tertiary-color p-[30px]'>
          <div className='flex flex-col items-center justify-center pt-10'>
              <Image src={"/logo.png"} alt={"Wagwan"} width={40} height={40} className="mb-10 md:w-20 md:h-20"/>
              <div className='text-center mb-20 md:mb-[150px] lg:max-w-[50%]'>
                  <h4 className='heading-h4 !font-light pb-8 '>
                      Are you a change maker?
                      Work with us.
                  </h4>
                  <h4 className='heading-h4 !font-light'>work@wagwanstudios.com</h4>
              ...
              <div className='grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4'>
                  ...
                  <div>
                      ...
                      <ul>
                          <li className="heading-h6 !font-light pb-3">sales@wagwanstudios.com</li>
